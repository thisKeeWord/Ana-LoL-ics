  ...
  render() {
    return (
      <div id="aboutMe">
        ...
        <div id="description">
          <p>Ana-LoL-ics doesn't just give a more
          specialized way of viewing stats by game - played on
          Summoner's Rift - it allows side-by-side analysis of games.</p>
          <p>Users can view stats - warding, creep score, deaths, etc - side-by-side,
          which should give a better and a more straightfoward idea of betterment.</p>
