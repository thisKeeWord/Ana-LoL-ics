...
class ChampBuild extends React.Component {
            ...
            for (let j = 0; j <= this.props.spot; j++) {
              if (searchEvents[j][0].events) {
                ...
                for (let k = 0; k < searchEvents[j][0].events.length; k++) {
                  ...
                  // ITEM_PURCHASED
                  if (
                    searchEvents[j][0].events[k].type === "ITEM_PURCHASED" &&
                  ...
                  // ITEM_DESTROYED
                  if (
                    searchEvents[j][0].events[k].type === "ITEM_DESTROYED" &&
                    searchEvents[j][0].events[k].participantId === player[0]
                  ) {
                  ...
                  // ITEM_SOLD
                  if (
                    searchEvents[j][0].events[k].type === "ITEM_SOLD" &&
                    searchEvents[j][0].events[k].participantId === player[0]
                  ) {
                    if (itemStore.lastIndexOf(findItem) !== -1) {
                      itemStore.splice(itemStore.lastIndexOf(findItem), 1);
                  ...
                  if (
                    searchEvents[j][0].events[k].type === "ITEM_UNDO" &&
                    searchEvents[j][0].events[k].participantId === player[0]
                  ) {
                    if (searchEvents[j][0].events[k].afterId === 0) {
                      ...
                      // }
                      itemStore.splice(
                        itemStore.lastIndexOf(searchEvents[j][0].events[k].beforeId),
                        1
                      );
                      let retrieveItem = k;
                      while (
                        searchEvents[j][0].events[retrieveItem] &&
                        searchEvents[j][0].events[retrieveItem].type !== "ITEM_PURCHASED" &&
                        findItem !== checkItemEvent
                      ) {
                        if (itemStorage[checkItemEvent].from) {
                          if (
                            searchEvents[j][0].events[retrieveItem].type === "ITEM_DESTROYED" &&
                            itemStorage[checkItemEvent].from.includes(
                              searchEvents[j][0].events[retrieveItem].itemId.toString()
                            )
                          ) {
                  ...
                  if (
                    (findItem === 3340 ||
                      ...
                      findItem === 3363 ||
                      findItem === 3364) &&
                    itemStore.indexOf(findItem) !== -1 &&
                    itemStore.lastIndexOf(findItem) !== itemStore.indexOf(findItem)
                  ) {
                    itemStore.splice(itemStore.lastIndexOf(findItem), 1);
                  }
                ...
                if (
                  player[0] <= 5 &&
                  findTrinket === false &&
                  searchEvents[j][0].participantFrames[player[0]].position
                ) {
                  if (
                    Math.sqrt(
                      Math.pow(
                        searchEvents[j][0].participantFrames[player[0]].position.x - 703,
                        2
                      ) +
                        Math.pow(
                          searchEvents[j][0].participantFrames[player[0]].position.y - 703,
                          2
                        )
                    ) > 4184
                  ) {
                    if (
                      !itemStore.includes(3340) &&
                      !itemStore.includes(3341) &&
                      !itemStore.includes(3363) &&
                      !itemStore.includes(3364)
                    ) {
                      itemStore.push(3340);
                      findTrinket = true;
                    }
                ...
                if (
                  ...
                  if (
                    Math.sqrt(
                      Math.pow(
                        searchEvents[j][0].participantFrames[player[0]].position.x - 14130,
                        2
                      ) +
                        Math.pow(
                          searchEvents[j][0].participantFrames[player[0]].position.y - 14130,
                          2
                        )
                    ) > 4204
                  ) {
              ...
              if (itemStore.includes(2003)) {
                for (
                  let countPotions = itemStore.lastIndexOf(2003);
                  countPotions >= itemStore.indexOf(2003);
                  countPotions--
                ) {
              ...
              if (itemStore.includes(2010)) {
                for (
                  let countBiscuits = itemStore.lastIndexOf(2010);
                  countBiscuits >= itemStore.indexOf(2010);
                  countBiscuits--
                ) {
              ...
              if (itemStore.includes(2055)) {
                for (
                  let countControlWards = itemStore.lastIndexOf(2055);
                  countControlWards >= itemStore.indexOf(2055);
                  countControlWards--
                ) {
            ...
            for (let z = 0; z < searchEvents.length; z++) {
              ...
              if (searchEvents[z][0].events) {
                for (let w = 0; w < searchEvents[z][0].events.length; w++) {
                  ...
                  // ITEM_PURCHASED
                  if (
                    searchEvents[z][0].events[w].type === "ITEM_PURCHASED" &&
                  ...
                  // ITEM_DESTROYED
                  if (
                    searchEvents[z][0].events[w].type === "ITEM_DESTROYED" &&
                    searchEvents[z][0].events[w].participantId === player[0]
                  ) {
                    if (itemStore.lastIndexOf(findItem) !== -1) {
                      itemStore.splice(itemStore.lastIndexOf(findItem), 1);
                  ...
                  // ITEM_SOLD
                  if (
                    searchEvents[z][0].events[w].type === "ITEM_SOLD" &&
                    searchEvents[z][0].events[w].participantId === player[0]
                  ) {
                    if (itemStore.lastIndexOf(findItem) !== -1) {
                      itemStore.splice(itemStore.lastIndexOf(findItem), 1);
                  ...
                  // ITEM_UNDO, PLAYER MAY HAVE "DESTROYED" RECIPE ITEMS TO GET NEW ONE
                  if (
                    searchEvents[z][0].events[w].type === "ITEM_UNDO" &&
                    searchEvents[z][0].events[w].participantId === player[0]
                  ) {
                    if (searchEvents[z][0].events[w].afterId === 0) {
                      ...
                      // }
                      itemStore.splice(
                        itemStore.lastIndexOf(searchEvents[z][0].events[w].beforeId),
                        1
                      );
                      let retrieveItem = w;
                      while (
                        searchEvents[z][0].events[retrieveItem] &&
                        searchEvents[z][0].events[retrieveItem].type !== "ITEM_PURCHASED" &&
                        findItem !== checkItemEvent
                      ) {
                        if (itemStorage[checkItemEvent].from) {
                          if (
                            searchEvents[z][0].events[retrieveItem].type === "ITEM_DESTROYED" &&
                            itemStorage[checkItemEvent].from.includes(
                              searchEvents[z][0].events[retrieveItem].itemId.toString()
                            )
                          ) {
                ...
                if (
                  player[0] <= 5 &&
                  findTrinket === false &&
                  searchEvents[z][0].participantFrames[player[0]].position
                ) {
                  if (
                    Math.sqrt(
                      Math.pow(
                        searchEvents[z][0].participantFrames[player[0]].position.x - 703,
                        2
                      ) +
                        Math.pow(
                          searchEvents[z][0].participantFrames[player[0]].position.y - 703,
                          2
                        )
                    ) > 4184
                  ) {
                ...
                if (
                  ...
                  if (
                    Math.sqrt(
                      Math.pow(
                        searchEvents[z][0].participantFrames[player[0]].position.x - 14130,
                        2
                      ) +
                        Math.pow(
                          searchEvents[z][0].participantFrames[player[0]].position.y - 14130,
                          2
                        )
                    ) > 4204
                  ) {
  ...
  appendItems(showItems) {
    ...
    if (
      (this.props.addItems1 && this.props.gamesToSee === 1) ||
      (this.props.addItems2 && this.props.gamesToSee === 2)
    ) {
      for (let i = 1; i <= this.props.gamesToSee; i++) {
  ...
  render() {
    ...
    if (this.props.gamesToSee === 1) {
      return (
        <div>
          <div id={"builds" + 1 * this.props.gamesToSee}>{items}</div>
