...
function comparePatchVersions(info, count, compareVersions, patchDesired, gameTimeline, idOfPlayer, imgOfChamp, positionOfPlayer, matchDataArray, req, res) {
    ...
    // console.log(versionChecks, 'versionChekc!!!!!')
    ...
    request("http://ddragon.leagueoflegends.com/cdn/" + patchDesired + "/data/en_US/item.json", function(err, data) {
      ...
      request("https://" + regionName + matchTimelineUrl + Object.keys(req.body)[0] + "?" + process.env.stuff8, function(er, timelineData) {
	      ...
	      console.log(gameTimeline, 'asdfasd')
	      ...
	      info.participants.forEach(function(i) {
	        ...
	        // console.log(regionName + champImageUrl + cId + '?' + process.env.stuff2)
	        request("https://" + regionName + champImageUrl + cId + '?' + process.env.stuff2, function(error, champData) {
	          ...
	          // console.log(timelineDataFrames, 'asdfasdfasdfasdfasdfasdfasdfasdfasdfasd')
	          // timelineDataFrames.frames.forEach(function(j) {
	          	// console.log(j)
